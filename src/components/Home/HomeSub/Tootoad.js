...
class Tootoad extends Component {
      render() {
        return (
          ...
          <div id="page-container" className="page-template-default page page-id-48307 page-child parent-pageid-48468 custom-background et_bloom et_button_no_icon et_pb_button_helper_class et_transparent_nav et_fullwidth_nav et_fixed_nav et_show_nav et_primary_nav_dropdown_animation_expand et_secondary_nav_dropdown_animation_fade et_header_style_left et_pb_footer_columns3 et_cover_background et_pb_gutter windows et_pb_gutters3 et_pb_pagebuilder_layout et_no_sidebar et_divi_theme et-db et_minified_js et_minified_css">
 ...
 <div id="main-content">
 		...
 		<div className="et_pb_section et_pb_section_0 et_pb_with_background et_section_regular section_has_divider et_pb_bottom_divider" >
				...
				<div className="et_pb_text_inner"><h1 style={{textAlign: "left"}}>Spordipsühholoogia <br /> <span className="yellow">töötoad</span></h1></div>
 			</div> <div className="et_pb_module et_pb_text et_pb_text_1 et_animated  et_pb_text_align_center et_pb_bg_layout_light">
      ...
      <div className="et_pb_column et_pb_column_1_2 et_pb_column_1  et_pb_css_mix_blend_mode_passthrough et-last-child">
 			...
 			</div> <div className="et_pb_column et_pb_column_1_2 et_pb_column_8 vertical-align  et_pb_css_mix_blend_mode_passthrough et-last-child">
        ...
        <img loading="lazy" src="../../../ts-uploads.azureedge.net/marketing/2019/09/GDPR3.png" alt="" title="" height="auto" width="auto"  className="wp-image-48322" /></span>
 			</div>
